...
import { GAME_IMAGES_STORAGE, SONG_STORAGE } from '@config/applicationFolders';
...
export default async ({ app }: { app: express.Application }) => {
  ...
  app.use('/songs', express.static(path.resolve(SONG_STORAGE)));
  app.use('/images', express.static(path.resolve(GAME_IMAGES_STORAGE)));
