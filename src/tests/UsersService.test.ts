...
describe('Users Service', () => {
  ...
  it('should find a user by id', async () => {
    ...
    const userFound = await UsersService.findUserByCpfOrId({
      id: createdUser.id,
    });
  ...
  it('should delete a user', async () => {
    ...
    const beforeDelete = await UsersService.findUserByCpfOrId({
      id: createdUser.id,
    });
  ...
  it('should check if a user has enough credits.', async () => {
    ...
    const result = await UsersService.checkInsufficientCreditsAndThrow(
      0,
      createdUser.id,
    );
  ...
  it('should add credit for a user', async () => {
    ...
    const updatedUser = await UsersService.changeCredit({
      creditsToChange: creditsToAdd,
      user: createdUser,
    });
  ...
  it('should remove credit from a user', async () => {
    ...
    await UsersService.changeCredit({
      creditsToChange: creditsToAdd,
      user: createdUser,
    });
    const updatedUser = await UsersService.removeCredit({
      creditsToChange: creditsToRemove,
      user: createdUser,
    });
  ...
  it('should throw an error when there are not enough credits', async () => {
    ...
    try {
      await UsersService.removeCredit({
        creditsToChange: creditsToRemove,
        user: createdUser,
      });
    } catch (error: any) {
